...
public class UserPrinciple implements UserDetails {
	...
	public UserPrinciple(Long id, String username, long mobileno, String password) {
		this.id = id;
	...
	public static UserPrinciple build(User user) {
		...
		return new UserPrinciple(user.getId(), user.getUsername(), user.getMobileno(), user.getPassword());
	}
